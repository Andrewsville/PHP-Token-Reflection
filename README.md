...
The current library version is 1.0 beta 4. That means that there are few features that need to be implemented but there should not be any significant changes in the public API.
